...
[![LinkedIn](https://img.shields.io/badge/Connect-LinkedIn-blue?style=for-the-badge&logo=linkedin)](https://www.linkedin.com)
...
## 🔥 What I Do
- 🚀 End-to-End Web, API & Mobile Test Automation  
- ⚙️ Playwright Frameworks (TypeScript, POM, BDD)  
- 🔄 CI/CD Integration (GitHub Actions, Jenkins, Docker)  
- 🧪 API Automation (Playwright API, Postman, Newman)  
- 🤖 AI-Powered Testing & Self-Healing Automation  

---

## 🧑‍💻 Currently

- 🛠 **Working on:** Playwright & API automation frameworks for real client projects  
- 🤝 **Open for:** Freelance, contract & remote QA roles  
- 🌱 **Learning:** AI-driven testing & smart test automation  
- 💬 **Ask me about:** Playwright, API testing, CI/CD, QA strategy  

---

## 🏆 Why Clients Hire Me
- ✅ 10+ years of experience in QA & Automation  
- ✅ Expert in Playwright + TypeScript  
- ✅ CI/CD-ready automation frameworks  
- ✅ Clean code, fast delivery, detailed reports  
- ✅ Experience in SaaS, E-commerce, Finance, Gaming, Health  
...
**API:** Playwright API, Postman, Newman  
**Testing:** UI, API, Regression, Smoke, End-to-End  
...
- 💼 **Upwork** – https://www.upwork.com/freelancers/~015564314311a8f360 
- 🛒 **Fiverr** – https://www.fiverr.com/users/priyam0393  
- 💬 **LinkedIn** – https://www.linkedin.com/in/priyam-shah-automation-engineer/
- 📧 **Email** – priyam.shah03@gmail.com  

---

⚡ **Fun fact:** I don’t just find bugs — I automate their elimination 😄
